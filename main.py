...
def launch_gui():
    ...
    class SplashScreen:
        ...
        def show(self):
            ...
            painter.drawText(0, 80, 500, 50, Qt.AlignmentFlag.AlignHCenter | Qt.AlignmentFlag.AlignVCenter, "Ngga Tutu")

            painter.setPen(QColor(139, 148, 158))
            painter.setFont(QFont("Segoe UI", 12))
            painter.drawText(0, 130, 500, 30, Qt.AlignmentFlag.AlignHCenter | Qt.AlignmentFlag.AlignVCenter, "Performance Benchmark")
